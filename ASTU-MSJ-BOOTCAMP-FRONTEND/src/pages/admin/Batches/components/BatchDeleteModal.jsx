...
export default function BatchDeleteModal({ isOpen, onClose, onConfirm, batch }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4 animate-fade-in">
      <div className="bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-sm p-6 space-y-4 text-center">
        ...
        <div className="space-y-1">
          <h3 className="text-lg font-bold text-slate-800">Delete Batch</h3>
          <p className="text-xs text-slate-500">
            Are you sure you want to delete <span className="font-semibold text-slate-700">{batch.name}</span>? This action cannot be undone.
          </p>
        </div>
